...
## Saving the data
```{r}
biomass_frozen_count_wm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, individual_count, wm_g, keep_data)

write_csv(biomass_frozen_count_wm_cleaned,
          here("data/processed/frozen/count_wm/biomass_frozen_count_wm_cleaned.csv"))
```
