...
```{r}
pred_mass <- taxa_nested_lm_ln_plot_coef_sf |>
  right_join(reg_summary_a) |>
...
pred_mass_error <- pred_mass |>
  select(taxa_clean, total_dm, reg_pred_dm, reg_pred_dm_percent_error, ratio_pred_dm, ratio_pred_dm_percent_error) |>
  unnest(cols = c(total_dm, reg_pred_dm, reg_pred_dm_percent_error, ratio_pred_dm, ratio_pred_dm_percent_error))

pred_mass_error_long <- pred_mass_error |>
...
ggplot(data = pred_mass_error_long, aes(x = pred_method, y = percent_error)) +
