...
```{r}
summary_frozen_wm_dm_ratios <- left_join(reg_summary_a_sf, biomass_frozen_wm_dm_cleaned_ratios)
...
```{r}
pred_mass_frozen_wm_dm_outliers_removed_MAPE <- taxa_nested_outliers_removed_lm_ln_plot_coef_CI_BT |>
...
pred_mass_frozen_wm_dm_outliers_removed_MAPE |> 
