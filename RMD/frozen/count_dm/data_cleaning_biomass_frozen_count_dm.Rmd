...
## Saving the data
```{r}
biomass_frozen_count_dm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, individual_count, dm_g, keep_data)

write_csv(biomass_frozen_count_dm_cleaned,
          here("data/processed/frozen/count_dm/biomass_frozen_count_dm_cleaned.csv"))
```
