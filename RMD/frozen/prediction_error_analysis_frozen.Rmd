...
```{r}
total_pred_mass_frozen_wm_dm <- pred_mass_frozen_wm_dm |>
...
total_pred_mass_frozen_wm_dm_plot <- total_pred_mass_frozen_wm_dm |>
  ...
  mutate(ols_pred_dm_percent_error_plot = map2(.x = data, 
         ...
         ratio_pred_dm_percent_error_plot = map2(.x = data, 
                                               ...
                                               .f = ~ ggplot(.x, aes(x = wm_g, y = ratio_pred_dm_percent_error)) +
                                                 ...
                                                 geom_hline(yintercept = 0, linetype = 2) +
                                                 ggtitle(.y)))
total_pred_mass_frozen_wm_dm_plot$ols_pred_dm_percent_error_plot
total_pred_mass_frozen_wm_dm_plot$ratio_pred_dm_percent_error_plot
