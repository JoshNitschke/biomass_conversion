...
## Saving the data
```{r}
biomass_frozen_wm_shell_on_dm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, wm_shell_on_g, dm_g, keep_data)

write_csv(biomass_frozen_wm_shell_on_dm_cleaned, here("data/processed/frozen/wm_shell_on_dm/biomass_frozen_wm_shell_on_dm_cleaned.csv"))
```
