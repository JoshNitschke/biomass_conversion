...
## Saving the data
```{r}
biomass_formalin_wm_afdm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, wm_g, afdm_g, keep_data)

write_csv(biomass_formalin_wm_afdm_cleaned, here("data/processed/formalin/wm_afdm/biomass_formalin_wm_afdm_cleaned.csv"))
```
