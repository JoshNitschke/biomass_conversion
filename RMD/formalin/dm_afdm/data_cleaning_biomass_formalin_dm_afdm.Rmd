...
## Saving the data
```{r}
biomass_formalin_dm_afdm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, dm_g, afdm_g, keep_data)

write_csv(biomass_formalin_dm_afdm_cleaned, here("data/processed/formalin/dm_afdm/biomass_formalin_dm_afdm_cleaned.csv"))
```
