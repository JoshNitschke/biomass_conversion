...
```{r}
biomass_formalin_count_afdm_ratios <- biomass_formalin_count_afdm_cleaned |>
...
write_csv(biomass_formalin_count_afdm_ratios,
...
```{r}
pred_mass_formalin_count_afdm_error_eval <- taxa_nested_lm_ln_plot_coef_CI_BT |>
  mutate(ols_pred_afdm = pmap(.l = list(data, a, slope, sf),
         ...
         ratio_pred_afdm = map2(.x = data,
                              .y = biomass_formalin_count_afdm_ratios$mean_afdm_count,
...
```{r}
pred_mass_formalin_count_afdm_outliers_removed_error_eval <- taxa_nested_outliers_removed_lm_ln_plot_coef_CI_BT |>
  mutate(ols_pred_afdm = pmap(.l = list(data, a, slope, sf),
                            .f = ~ ..2*(..1$individual_count)^..3*..4),
         ols_pred_afdm_percent_error = map2(.x = data,
                                          .y = ols_pred_afdm,
...
```{r}
summary_formalin_count_afdm_ratios <- left_join(reg_summary_a_sf, 
                                         biomass_formalin_count_afdm_ratios) |>
  left_join(pred_mass_formalin_count_afdm_error_eval)
...
summary_formalin_count_afdm_ratios_outliers_removed <- left_join(reg_summary_outliers_removed_a_sf,
  ...
  left_join(pred_mass_formalin_count_afdm_outliers_removed_error_eval) |>
