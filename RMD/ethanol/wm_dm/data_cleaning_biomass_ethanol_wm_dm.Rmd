...
## Saving the data
```{r}
biomass_ethanol_wm_dm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, wm_g, dm_g, keep_data)

write_csv(biomass_ethanol_wm_dm_cleaned, here("data/processed/ethanol/wm_dm/biomass_ethanol_wm_dm_cleaned.csv"))
```
