...
## Saving the data
```{r}
biomass_ethanol_count_afdm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, individual_count, afdm_g, keep_data)

write_csv(biomass_ethanol_count_afdm_cleaned,
          here("data/processed/ethanol/count_afdm/biomass_ethanol_count_afdm_cleaned.csv"))
```
