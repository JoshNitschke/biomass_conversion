...
write_csv(biomass_ethanol_count_afdm_cleaned_ratios,
...
```{r}
summary_ethanol_count_afdm_ratios <- left_join(reg_summary_a_sf, biomass_ethanol_count_afdm_cleaned_ratios)
...
```{r}
pred_mass_ethanol_count_afdm_outliers_removed_MAPE <- taxa_nested_outliers_removed_lm_ln_plot_coef_CI_BT |>
...
pred_mass_ethanol_count_afdm_outliers_removed_MAPE |> 
