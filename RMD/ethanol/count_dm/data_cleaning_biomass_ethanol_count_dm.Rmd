...
## Saving the data
```{r}
biomass_ethanol_count_dm_cleaned <- taxa_unnested_keep_data_merged |>
  select(taxa_clean, individual_count, dm_g, keep_data)

write_csv(biomass_ethanol_count_dm_cleaned,
          here("data/processed/ethanol/count_dm/biomass_ethanol_count_dm_cleaned.csv"))
```
